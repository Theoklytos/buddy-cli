...
_REGISTRY: dict[str, dict] = {
    ...
    "voyage-3": {
        ...
        "chunk_min_tokens": 10,
        "provider": "voyage",
        "description": "Voyage 3 — 1024 dims, 32K-token context",
        "known": True,
    },
    "voyage-3-large": {
        "dimension": 1024,
    ...
    "voyage-4": {
        ...
        "chunk_min_tokens": 10,
        "provider": "voyage",
        "description": "Voyage 4 — 1024 dims, 32K-token context",
        "known": True,
    },
    "voyage-4-large": {
        "dimension": 1024,
    ...
    "voyage-4-lite": {
        ...
        "chunk_min_tokens": 10,
        "provider": "voyage",
        "description": "Voyage 4 Lite — 512 dims, 32K-token context",
        "known": True,
    },
    "voyage-code-3": {
        "dimension": 1024,
    ...
    "voyage-finance-2": {
        ...
        "chunk_min_tokens": 10,
        "provider": "voyage",
        "description": "Voyage Finance 2 — 1024 dims, 16K-token context",
        "known": True,
    },
    "voyage-large-2-instruct": {
        ...
        "chunk_min_tokens": 10,
        "provider": "voyage",
        "description": "Voyage Large 2 Instruct — 1024 dims, 16K-token context",
        "known": True,
    },
}
